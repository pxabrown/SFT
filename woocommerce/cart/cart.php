...
<form action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<h5 class="bag-summary"><?php _e('Your selection', '');?> <span>(<?php global $woocommerce; ?>
 
<a class="cart-contents" href="<?php echo $woocommerce->cart->get_cart_url(); ?>" title="<?php _e('View your shopping bag', 'woothemes'); ?>"><?php echo sprintf(_n('%d item', '%d items', $woocommerce->cart->cart_contents_count, 'woothemes'), $woocommerce->cart->cart_contents_count);?></a>): <strong class="cart-total-topper"><?php echo $woocommerce->cart->get_cart_total(); ?></strong></span></h5>
				...
				<?php if ( WC()->cart->coupons_enabled() ) { ?>
					<div class="coupon">
						...
						<h4 class="lined-heading"><span><?php _e('Promotional Code', ''); ?></span></h4>
